...
/**
 * Highlights Feed: a stream of recent post-match highlight clips across the nine
 * competitions, sourced from official YouTube channels (embeds only). Falls back
 * to preview clips until a YOUTUBE_API_KEY is configured.
 */
export default async function FeedPage() {
  const feed = await highlights.getFeed({ limit: 36 });
    ...
    <AppShell>
      <header className="mb-6">
        ...
        <p className="mt-1 text-meta text-text-secondary">
          Post-match highlights from across the nine competitions.
        </p>
      </header>
