  ...
  return (
    <LegalLayout title="Privacy Policy" updated="30 June 2026">
      ...
      <LegalSection heading="Information we collect">
        ...
        <p>
          <strong>Feedback.</strong> The site offers an optional feedback form. If you send
          feedback, we store your message and, if you choose to provide them, a star rating and an
          email address. We use this only to improve the Service and, where you left an email, to
          reply to you. We do not use feedback for marketing and do not share it with advertisers.
          Providing feedback is entirely optional, and you can request removal of anything you sent
          at any time via <a href="mailto:privacy@myfootballtracker.com">privacy@myfootballtracker.com</a>.
        </p>
        <p>
